...
You can also follow the [Software-Carpentry Python stetup instructions](https://carpentries.github.io/workshop-template/#python)
-->
...
If you see a "*" it means it is still execuring the code.
